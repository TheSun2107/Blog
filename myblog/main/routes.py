...
from myblog.main import bp
from myblog.main.forms import EditProfileForm
...
def user(username):
    ...
    prev_url = url_for('main.user', username=user.username, page=posts.prev_num) \
        if posts.has_prev else None
    return render_template('view_user.html', user=user, posts=posts.items, next_url=next_url, prev_url=prev_url)
...
def list_user():
    ...
    return render_template("list_user.html", title='List User', users=users)